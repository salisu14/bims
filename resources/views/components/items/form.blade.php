            ...
            <div class="pt-8">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Add information about the item to make it easier to understand later.
                    </p>
                </div>
                <form id="item_form" method="POST" action="" class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    @csrf
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <p class="mt-2 text-sm text-gray-500">
                            Write any notes about this item.
                        </p>
                        @error('description')
                        <p class="mt-2 text-sm text-red-500">
                            {{ $message }}
                    ...
                    <div class="sm:col-span-6">
                        <div class="pt-5">
                            <div class="flex justify-end">
                                <a x-on:click.prevent="document.getElementById('item_form').reset();" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    Cancel
                                </a>
